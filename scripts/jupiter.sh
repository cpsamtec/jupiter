...
SYSTEM_ARCH=$(uname -m)
BUILD_ARGS="BUILD_ARG BASE_IMAGE_ARCH=DOCKER_ARCH BUILD_ARG JUPI_NOTEBOOK_BASE_NAME=${JUPI_NOTEBOOK_BASE_NAME:-DOCKER_ARCH/ubuntu:groovy-20210225} BUILD_ARG SDS_BASE_IMAGE=DOCKER_ARCH/python:3.8-alpine3.13"
